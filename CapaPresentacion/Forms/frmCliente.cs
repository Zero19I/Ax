...
namespace CapaPresentacion.Forms
{
    public partial class frmCliente : Form
    {
...

        {
            ...
            {
                dgvdata.Rows.Add
                (new object[] {"",item.PkCliente_Id,item.Documento,item.Nombre,item.Correo,item.Telefono,
...

            {
                ...
                if (obj.PkCliente_Id == 0)
                {
                    ...
                    if (idgenerado != 0)
                    {
                        ...
                        {"",idgenerado,txtUsuario.Text,txtNombre.Text,txtCorreo.Text,txtCelular.Text,
