...
namespace CapaPresentacion.Forms
{
    public partial class frmProveedores : Form
    {
...

        {
            ...
            {
                dgvdata.Rows.Add
                (new object[] {"",item.PkProveedor_Id,item.Documento,item.RazonSocial,item.Correo,item.Telefono,
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (obj.PkProveedor_Id == 0)
            {
                ...
                if (idgenerado != 0)
                {
                    ...
                    {"",idgenerado,txtDocumento.Text,txtRazonSocial.Text,txtCorreo.Text,txtCelular.Text,
